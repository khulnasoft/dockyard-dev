    ...
    <v-card class="pa-3">
      ...
      <v-card-text class="text-center">
        ...
        <div class="text-h6">
          ...
          ie. https://raw.githubusercontent.com/khulnasoft/dockyard-api/main/default_template.json
        </div>
...
interface Emits {
  (e: 'createApp', app: DockyardTemplate['templates'][0]): void
  (e: 'openInfo', app: DockyardTemplate['templates'][0]): void
}
defineEmits<Emits>()
interface Props {
  template: DockyardTemplate,
  search: string
}
defineProps<Props>()
</script>

<style></style>~/shared/templates/dockyard