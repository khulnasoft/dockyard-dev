          ...
          <v-list-item class="align-center">
            <v-row align="center">
              ...
              <!-- <v-text-field dense label="template url" hide-details="auto"
                placeholder="https://raw.githubusercontent.com/khulnasoft/dockyard-api/main/default_template.json" /> -->
              <v-col cols="3">
...
<style></style>~/shared/templates/dockyard~/shared/forms